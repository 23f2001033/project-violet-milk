...
def build_dossier(
    ...
    doc = SimpleDocTemplate(
        ...
        author="Chandigarh Police Cyber Crime Unit",
    )
    ...
    story.append(Paragraph(
        "This certificate accompanies the electronic record produced above. "
        "The analysis was generated by an automated system operated by the "
        "Cyber Crime Unit during the period of the investigation. The source "
        "records were ingested in the ordinary course of the investigation and "
        "their integrity is evidenced by the cryptographic digests tabulated "
        "below. The computer output was produced by deterministic, "
        "reproducible processing of those records; the scoring rules and their "
        "weights are stated in full in the risk appendix so that any reader may "
        "recompute the result independently.", S_BODY))
    story.append(Paragraph(
        "<b>Certification of this document under Section 63 remains the "
        "responsibility of the certifying officer named below. This software "
        "prepares the material; it does not itself certify it.</b>", S_BODY))
